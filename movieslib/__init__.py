...
MoviesLib_app.config['MONGOALCHEMY_USER'] = os.environ['MONGOLAB_USER'] #movieslibapp
MoviesLib_app.config['MONGOALCHEMY_PASSWORD'] = os.environ['MONGOLAB_PASSWD'] #movieslibapp_passwd
